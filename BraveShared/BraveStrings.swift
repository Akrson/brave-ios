...
extension Strings {
  ...
  public static let notEnoughWordsTitle = NSLocalizedString("NotEnoughWordsTitle", tableName: "BraveShared", bundle: .strings, value: "Not Enough Words", comment: "Sync Alert")
  public static let notEnoughWordsDescription = NSLocalizedString("NotEnoughWordsDescription", tableName: "BraveShared", bundle: .strings, value: "Please enter all of the words and try again.", comment: "Sync Alert")
  public static let invalidSyncCodeDescription = NSLocalizedString("InvalidSyncCodeDescription", tableName: "BraveShared", bundle: .strings, value: "Invalid Sync Code", comment: "Sync Alert")
  ...
  public static let syncNewerVersionError = NSLocalizedString("syncNewerVersionError", tableName: "BraveShared", bundle: .strings, value: "This sync code was generated by a newer version of Brave on another device. Please update Brave on all synced devices and try again.", comment: "Sync Error Description")
  public static let syncInsecureVersionError = NSLocalizedString("syncInsecureVersionError", tableName: "BraveShared", bundle: .strings, value: "This sync code was generated by an outdated version of Brave on another device. Please update Brave on all synced devices and try again.", comment: "Sync Error Description")
  public static let syncInvalidVersionError = NSLocalizedString("syncInvalidVersionError", tableName: "BraveShared", bundle: .strings, value: "Invalid Format", comment: "Sync Error Description")
  public static let syncExpiredError = NSLocalizedString("syncExpiredError", tableName: "BraveShared", bundle: .strings, value: "Expired", comment: "Sync Error Description")
  public static let syncFutureVersionError = NSLocalizedString("syncFutureVersionError", tableName: "BraveShared", bundle: .strings, value: "Too New", comment: "Sync Error Description")
  public static let syncGenericError = NSLocalizedString("syncGenericError", tableName: "BraveShared", bundle: .strings, value: "Sorry, something went wrong", comment: "Sync Error Description")
}
